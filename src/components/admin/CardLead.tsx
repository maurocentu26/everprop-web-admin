      ...
      <div className="flex flex-col gap-3">
        <div className="flex-1 w-full">
          ...
          <div className="flex flex-col">
            <div className="font-bold text-slate-900 leading-tight truncate pr-16">{name}</div>
            <div className="text-[10px] text-slate-400 font-medium uppercase tracking-tighter mt-0.5">Vía {origin || 'Web'}</div>
          </div>
          ...
          {/* Precio y Acciones */}
          <div className="mt-4 flex items-center justify-between w-full pt-3 border-t border-slate-50">
