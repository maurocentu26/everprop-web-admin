...
const projectSchema = z.object({
  ...
  totalUnits: z.number().min(1, "Debe tener al menos 1 unidad"),
            ...
            <div role="radiogroup" className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              {[
                ...
                <label
                  ...
                  htmlFor={type.id}
                  className={cn(
                    "flex cursor-pointer flex-col items-center justify-between rounded-xl border-2 bg-white p-4 transition-all hover:bg-slate-50",
                    selectedType === type.id ? "border-blue-600 bg-blue-50" : "border-slate-100",
                  )}
                >
                  <input
                    {...register("type")}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="totalUnits" type="number" {...register("totalUnits", { valueAsNumber: true })} placeholder="120" className="h-12 pl-10" />
              </div>
            ...
            <div className="space-y-2">
              ...
              <Input id="progress" type="number" {...register("progress", { valueAsNumber: true })} placeholder="0" className="h-12" />
            ...
            {[
              ...
              <div key={service.id} className="flex items-center space-x-2">
                <input
                  ...
                  className="h-4 w-4 cursor-pointer rounded border-slate-300 accent-blue-600 focus:ring-2 focus:ring-blue-500/30"
                />
